...
@endsection
	  			...
	  			<div class="flex-min-height-inner">
		  			...
		  			<div class="container top-bottom-padding-120">
				  	    ...
				  	    <h3 class="large-title-bold text-color-4">
								...
								<h2 class="small-title-oswald overlay-loading2 overlay-light-bg-1 gold-color tr-delay04 animated overlay-anim2">Start: 22. Oktober 2022&nbsp;&nbsp;|&nbsp;&nbsp;Frankfurt</h2>
								<br>
			...
			{{-- section start --}}
			<section class="bottom-padding-30 top-padding-0" data-midnight="black">

				{{-- bottom-padding-90 start --}}
				<div class="" id="Digitalisierung">
